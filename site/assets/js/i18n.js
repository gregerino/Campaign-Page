const TRANSLATIONS = {
  en: {
    ...
    "home.objective.text": "Our next destination is Conyberry. Wyvern Tor has been cleared.",
  ...
  sv: {
    ...
    "home.objective.text": "Nästa mål är Conyberry. Wyvern Tor är rensat.",
...
const SESSION_TEXT = {
  en: {
    ...
    s6: {
      recap: "The Triboar Trail stretched ahead of us, familiar in the way that danger always is when you have walked it before. We had been walking for nearly two hours when Lior noticed the birds. Not their song, their silence, and then the sudden burst of wings from a thicket ahead. He read the sign before anyone else could speak. He threw a stone toward the creek to test the stillness, then slipped off the road and into the treeline without a word.\n\nWhat he found froze him in place. Hobgoblins, armored and disciplined, crouched in formation along both sides of the trail. This was not a goblin ambush. This was a military operation. Lior did something none of us expected: he cast Disguise Self, shifted his form into that of a Hobgoblin, and walked straight into their ranks. They showed him a rolled parchment, a bounty poster bearing Faelaris's face, sealed with the unmistakable sigil of a black spider web. The Spider had put a price on us. Lior tried to stall them with a Minor Illusion, tried to convince one group that we were allies. It half-worked: one squad hesitated, confused. The other charged onto the road.\n\nThe fight was sharp and brutal. Steel rang against steel in the forest shade, and when the last Hobgoblin fell, we stood among the bodies catching our breath. Among the dead we found coin and gear worth claiming: a cloak for Brander, a pair of gloves for Faelaris, a dagger for Lior, and a circlet for Corvus.\n\nWe pressed on toward The Dogwater Inn, arriving as the sun dipped below the treeline. The inn was everything Phandalin was not: loud, crowded, and smelling of smoke, roasted meat, and something sour that might have been the Putrid Pint. Roscoe, the broad-shouldered barkeep with a face carved from years of hard living, poured drinks and watched everything. Fleurette Grubbfin, a halfling woman barely taller than the tables she served, bustled between patrons with plates balanced on both arms and a smile that never faltered.\n\nBrander could not resist the Putrid Pint challenge: a drinking contest involving a brew of dog water, drool, crumbs, and other filth so foul that most challengers were on the floor within seconds. He drained it, slammed the tankard down, and grinned. The inn erupted. Meanwhile, Lior tested his growing power by making a glass slide across the table with nothing but concentration, and Corvus quietly scraped candle wax into his pouch, collecting materials the way he always does, methodically, without explanation.\n\nThe rumors at the inn painted a darker picture of the road ahead. A hunting guide, surrounded by overdressed nobles at a long table, spoke of Cragmaw Castle in grim terms: the goblins there file their teeth to points, and they are aggressive beyond reason. He also mentioned a hunter named Gustaf, known as Falcon, who lives deep in Neverwinter Wood, and a Loggers Camp on the Neverwinter River run by Tibor Wester. A shepherd at a corner table spoke in a shaking voice of something that had attacked his flock near Thundertree: enormous, the size of three warhorses, with wings like a bat. It came from the sky and took a sheep as if it weighed nothing. And Roscoe himself, leaning close to Brander, told him of sick people near Old Owl Well, people with rotting flesh, and asked him to look into it.\n\nThat night at the inn, Brander woke drenched in sweat, the same nightmare clinging to him: a battlefield, someone falling, the dream ending before he can see who. He sat on the edge of his bed afterward, staring at the wall, unable to return to sleep.\n\nThe next morning, Roscoe pressed a knife into Lior's hands and told him that his own adventures were no greater than the ones that happen right here at The Dogwater Inn. Lior accepted the blade without a word. Before we left, he placed five gold coins on the table as thanks for the hospitality, slipping away before Roscoe could notice. We packed our things and set out.\n\nOn the trail east, we met Bramblewick Quickpocket, a halfling merchant whose wagon was a small wonderland of oddities, trinkets, and supplies. His grin was wider than his donkey was long, and his prices were fair enough that we stocked up before moving on.\n\nThe mood shifted when we found another wagon, attacked and destroyed. A body lay nearby. We searched the wreckage but found nothing of value, only the story the scene told: goblins from Cragmaw Castle, striking further and further from their stronghold. We buried the dead, set the wagon ablaze, and continued in silence.\n\nThat night, at camp, the quiet became heavy. Lior sat in his tent with a candle burning, watching his own shadow on the canvas. The shadow did not mirror him. It moved on its own, sharpening something, a knife perhaps. He watched it with an acceptance that unsettled something deep. Corvus held the black glass shard up to the firelight, turning it slowly, feeling the pull of it, the shame, the whisper of something he cannot name. Faelaris lay in his tent and stared at nothing, replaying the vision that had struck him earlier: a sky turned completely black, the world beneath it silent.\n\nThe next morning, Lior was up first. He built the fire and cooked for everyone without being asked. Brander tried to eat, managing a few bites of the meat he had bought from Bramblewick. Corvus emerged, stretched, and asked if there was food. Faelaris watched the others from a distance, quiet as always. They packed up, doused the fire properly, and walked east toward Conyberry, toward whatever waits there."
    },
    s7: {
      recap: "The Triboar Trail lay long and dusty ahead of them, a road they had come to know the way you learn a place that tests your resolve again and again. But something had changed. Lior felt it first, like a thorn in the mind. This was no longer random chaos. Someone was pulling the strings. Someone was organizing the hunt.\n\nTheir second day on the road was strangely still, almost too still. A felled deer gave them meat for the journey, and as the evening campfire crackled beneath the stars, the night filled with simpler things: laughter, competition, and rest. Brander taught a confident but entirely inexperienced Lior the rules of Dragonchess and took his third straight victory. Corvus tried to reclaim the honor but fell to Brander's tactics as well. Faelaris sat quietly, restringing his bow, while Corvus let himself disappear into thoughts he shared with no one. Beneath the calm surface, each of them carried something.\n\nWhen morning came, the road led them not where they had intended, but to Wyvern Tor.\n\nThe cave entrance lay hidden among the rocks, guarded by a bugbear with watchful eyes. The group melted into the terrain: Lior and Faelaris among the thickets, Brander and Corvus behind the stones by the road. With cunning instead of force, they lured the first bugbear away from the cave mouth when Corvus hurled a stone off the path, close enough to draw the guard's attention but far enough to pull him from his post. The bugbear went to investigate the sound, and there, separated from the cave, he fell to the group's silent precision without raising an alarm.\n\nWhen they peered into the cave, they saw Brughor Axe-Biter, his ogre Gog, and another bugbear gathered around a glowing fire. The second bugbear was lured out with the same cunning. Brander spoke with a puffed-up bullfinch and persuaded it to create enough of a disturbance to draw the guard out. The bird launched its tiny assault, the bugbear gave chase, and he too met the same quiet, lethal end outside the cave.\n\nWhat followed was not a storm of steel, but a perfect chain of small chaos. When Gog charged out of the cave, he was met by Corvus's flaming magic, a ball of wax that exploded into a burning sphere, before Brander finished the beast with brutal precision. Brughor Axe-Biter fell, Gog fell, and Wyvern Tor went silent.\n\nBut the cave gave them more than blood.\n\nStanding inside the cave, Faelaris put the pieces together. This was the place Harbin Wester had spoken of, the threat the Townmaster had helplessly asked for aid with, and Faelaris realized a reward awaited those who cleared Wyvern Tor. Corvus found a note on a dead bugbear, a clear lead that mentioned Butterskull Ranch. In the camp they also found traces of stolen cattle, and more hoof prints led further east, as if animals had been driven from somewhere farther away. The tracks and the note together pointed toward the ranch to the north. Among the cave's possessions they found a small hoard of coins and valuables, riches that bugbears and Brughor had amassed by robbing caravans and unlucky travelers on the roads.\n\nAnd on the cave walls they found something older than marauders and orcs: a painting of an elf caught in a black spiderweb, beside a strange goblin with an elongated head and crystal-like growth. The same kind of creature they had seen before. A sign that multiple dark forces were moving through the region at once.\n\nThat night they made camp in the forest and feasted on their victory.\n\nDuring first watch, Lior saw something in the darkness: a skeleton resting in a hollowed-out old oak. There he found a sword that glowed with still moonlight, a Moon-Touched Sword, marked by Selûne's power. He woke Brander, and together they stood in the night's silence, letting the cold light play across the blade.\n\nThe next morning they continued their journey toward Conyberry. But along the way they found something they had not expected.\n\nOld Owl Well rose from the landscape like a ruin from another age, and even before they drew close, something felt wrong. The air was heavy. The ground was still in the wrong way. Brander extended his divine sense and found the truth hidden beneath rotten stench and human silhouettes. What moved there were not sick people. They were the walking dead.\n\nAnd in their midst stood a man in red robes. Hamun.\n\nLior's past stepped out of the shadows and spoke his name as though no years had passed. \"Interesting that you are still alive... Lior,\" Hamun said, his eyes flickering to the ring on Lior's hand, a ring that mirrored his own.\n\nHamun did not raise his voice. He did not need to. He spoke of the defected agent Lior had sent the wrong way, of guilt carried for the wrong reasons. \"Do you know what your greatest mistake was, Lior? You believed that survival meant freedom.\"\n\nThen his words turned darker. He spoke of children in Thay, of minds that are soft, easier to open. \"Do you know what we teach children first in Thay? That screaming passes. But eventually, everyone screams the same thing: that they want to die. That is when the real work can begin.\" He pointed slowly at Lior. \"But you survived. And that makes you interesting.\"\n\nThe ring on Lior's finger pulsed with urgent light. Hamun held his own ring between two fingers. \"That ring was never meant as a souvenir. It marked you. The whispers you hear? That is not madness. Those are echoes.\"\n\nHamun reached toward Lior's hand. The silver ring cracked with a sound like breaking glass. Green necrotic flames crawled across its surface, turning the silver black. When the flames subsided, the Red Wizards' sigil glowed faintly in the center of the ring.\n\nHe tilted his head. \"You think magic is a gift. It is not. It is hunger. And hunger does not care about morality.\" His gaze held Lior's. \"Every time you use your magic, every time you move a coin without touching it, every time you feel curiosity winning over guilt... a part of you is already choosing us.\"\n\nHe turned one last time. \"Keep running if you want, Lior Fenn. But Red Wizards do not lose investments. Now we know where you are. Next time, we will not just take you. We are closer than you think.\"\n\nA green shimmer appeared around his hand, a Dimension Door opened behind him, and Hamun stepped through and was gone.\n\nThe group stood at Old Owl Well's ruins with more questions than answers.\n\nBrughor Axe-Biter was dead. Wyvern Tor was cleared. The tracks pointed toward Butterskull Ranch. Hamun had returned from Lior's past. But their goal still lay ahead of them.\n\nConyberry awaits."
    }
  },
  sv: {
    s1: {
    ...
    s6: {
      recap: "Triboar Trail sträckte sig framför oss, bekant på det sättet fara alltid är när man vandrat den förut. Vi hade vandrat i nästan två timmar när Lior märkte fåglarna. Inte deras sång, utan deras tystnad, och sedan den plötsliga fladdrande flykten ur ett snår längre fram. Han läste tecknet innan någon annan hann tala. Han kastade en sten mot bäcken för att testa stillheten, och gled sedan av från vägen och in bland träden utan ett ord.\n\nVad han fann fick honom att stelna till. Hobgoblins, rustade och disciplinerade, hukade i formation längs båda sidor av stigen. Det här var inget goblinbakhåll. Det här var en militär operation. Lior gjorde något ingen av oss hade förväntat: han kastade Disguise Self, förändrade sin form till en Hobgoblin, och gick rakt in i deras led. De visade honom en hoprullad pergamentrulle, en efterlysningsaffisch med Faelaris ansikte, förseglad med det omisskännliga sigillet av ett svart spindelnät. The Spider hade satt ett pris på oss. Lior försökte fördröja dem med en Minor Illusion, försökte övertyga ena gruppen att vi var allierade. Det fungerade halvvägs: en trupp tvekade, förvirrad. Den andra stormade ut på vägen.\n\nStriden var skarp och brutal. Stål slog mot stål i skogens skugga, och när den sista Hobgoblinen föll stod vi bland kropparna och hämtade andan. Bland de döda hittade vi mynt och utrustning värd att ta: en kappa åt Brander, ett par handskar åt Faelaris, en dagger till Lior och en krona till Corvus.\n\nVi tryckte på mot The Dogwater Inn och anlände när solen sjönk bakom trädtopparna. Värdshuset var allt Phandalin inte var: högt, fullpackat, och luktande av rök, stekt kött och något surt som möjligen var Putrid Pint. Roscoe, den bredaxlade barkeepern med ett ansikte mejslat av år av hårt liv, hällde drycker och bevakade allt. Fleurette Grubbfin, en halvlingskvinna knappt längre än borden hon serverade, flängde mellan gästerna med tallrikar balanserade på båda armarna och ett leende som aldrig vacklade.\n\nBrander kunde inte motstå Putrid Pint-utmaningen: en dryckestävling med en brygd av hundvatten, dreggel, smulor och annat smuts, så vidrig att de flesta utmanare låg på golvet inom sekunder. Han tömde den, slog ner sejdeln och flinade. Värdshuset exploderade. Samtidigt testade Lior sin växande kraft genom att få ett glas att glida över bordet med inget annat än koncentration, och Corvus skrapade tyst ljusvax i sin påse, samlande material på det sätt han alltid gör: metodiskt, utan förklaring.\n\nRyktena på värdshuset målade en mörkare bild av vägen framåt. En jaktguide, omgiven av överdressade adelsmän vid ett långbord, talade om Cragmaw Castle i dystra ordalag: goblinsarna där filar sina tänder till spetsar, och de är aggressiva bortom all rimlighet. Han nämnde också en jägare vid namn Gustaf, kallad Falcon, som lever djupt inne i Neverwinter Wood, och ett Loggers Camp vid Neverwinter River som drivs av Tibor Wester. En herde vid ett hörnbord talade med skakig röst om något som attackerat hans flock nära Thundertree: enormt, stort som tre arbetshästar, med vingar som en fladdermus. Det kom från himlen och tog ett får som om det inte vägde någonting. Och Roscoe själv, lutande sig nära Brander, berättade om sjuka människor nära Old Owl Well, människor med ruttnande kött, och bad honom undersöka saken.\n\nDen natten på värdshuset vaknade Brander badande i svett, samma mardröm som klamrade sig fast: ett slagfält, någon som faller, drömmen som tar slut innan han ser vem. Han satte sig på sängkanten efteråt och stirrade på väggen, oförmögen att somna om.\n\nNästa morgon tryckte Roscoe en kniv i Liors händer och sa att hans egna äventyr inte var större än de som utspelar sig här på The Dogwater Inn. Lior tog emot bladet utan ett ord. Innan vi gick la han fem guldmynt på bordet som tack för gästfriheten, och smög iväg innan Roscoe hann märka det. Vi packade och gav oss av.\n\nPå stigen österut mötte vi Bramblewick Quickpocket, en halvlingshandlare vars vagn var ett litet underverk av kuriositeter, prydnader och förnödenheter. Hans flin var bredare än hans åsna var lång, och hans priser var rimliga nog att vi fyllde på förråden innan vi fortsatte.\n\nStämningen skiftade när vi hittade en annan vagn, attackerad och förstörd. En kropp låg intill. Vi genomsökte vraket men fann inget av värde, bara berättelsen som scenen avslöjade: goblins från Cragmaw Castle, som slår till längre och längre från sin fästning. Vi begravde den döde, tände eld på vagnen och fortsatte i tystnad.\n\nDen kvällen, vid lägret, blev tystnaden tung. Lior satt i sitt tält med ett ljus brinnande och tittade på sin egen skugga mot tältduken. Skuggan speglade inte honom. Den rörde sig på egen hand, slipade något, en kniv kanske. Han betraktade den med en acceptans som oroade något djupt. Corvus höll den svarta glasskärvan mot eldljuset, vände den långsamt, kände dragningen av den, skammen, viskningen av något han inte kan ge namn. Faelaris låg i sitt tält och stirrade på ingenting, spelade om visionen som träffat honom tidigare: en himmel helt svartnad, världen under den tyst.\n\nNästa morgon var Lior uppe först. Han byggde elden och lagade mat åt alla utan att bli tillfrågad. Brander försökte äta, lyckades med några tuggor av köttet han köpt av Bramblewick. Corvus klev ut, sträckte på sig och frågade om det fanns mat. Faelaris betraktade de andra på avstånd, tyst som alltid. De packade ihop, släckte elden ordentligt, och vandrade österut mot Conyberry, mot vad som än väntar där."
    },
    s7: {
      recap: "Triboar Trail låg lång och dammig framför dem, en väg de nu börjat känna igen på det där sättet man lär känna en plats som gång på gång testar ens mod. Men något hade förändrats. Lior kände det först, som en tagg i tanken. Det här var inte slumpmässigt kaos längre. Någon drog i trådarna. Någon organiserade jakten.\n\nDeras andra dag på vägen blev märkligt stillsam, nästan för stillsam. Ett fällt rådjur gav dem kött för färden, och medan kvällens lägereld sprakade under stjärnhimlen fylldes natten av enklare saker, skratt, tävlan och vila. Brander undervisade en självsäker men helt oerfaren Lior i Dragonchess och tog sin tredje raka seger. Corvus försökte vinna tillbaka äran men föll även han för Branders taktik. Faelaris satt tyst och strängade om sin båge medan Corvus lät sig själv försvinna in i tankar han inte delade med någon. Under den lugna ytan bar alla på något.\n\nNär morgonen kom förde vägen dem inte dit de tänkt, utan till Wyvern Tor.\n\nGrottöppningen låg dold bland klipporna, bevakad av en bugbear med vaksamma ögon. Gruppen smälte in i terrängen, Lior och Faelaris bland snåren, Brander och Corvus bakom stenarna vid vägen. Med list istället för kraft lurade de bort den första bugbearen från grottöppningen när Corvus kastade en sten bort från vägen, tillräckligt nära för att dra vaktens uppmärksamhet men långt nog för att locka honom bort från sin post. Bugbearen gick för att undersöka ljudet, och där, avskild från grottan, föll han för gruppens smygande precision utan att hinna slå larm.\n\nNär de kikade in i grottan såg de Brughor Axe-Biter, hans ogre Gog och ännu en bugbear runt en glödande eld. Även den andra bugbearen lockades bort med slughet. Brander talade med en uppbröstad domherre och övertalade den att skapa ett tillräckligt störande kaos för att dra ut vakten. Fågeln kastade sig in i sitt lilla anfall, bugbearen rusade efter, och även han mötte samma tysta, dödliga slut utanför grottan.\n\nDet som följde var inte en storm av stål, utan en perfekt kedja av små kaos. När Gog rusade ut ur grottan möttes han av Corvus flammande magi, en vaxboll som exploderade till en brinnande sfär, innan Brander avslutade besten med brutal precision. Brughor Axe-Biter föll, Gog föll, och Wyvern Tor tystnade.\n\nMen grottan gav dem mer än blod.\n\nNär Faelaris stod inne i grottan föll bitarna på plats. Detta var platsen Harbin Wester hade talat om, hotet som Townmaster oförmöget bett om hjälp med, och Faelaris insåg att en belöning väntade för den som rensade Wyvern Tor. Corvus fann en lapp på en död bugbear, en tydlig ledtråd som nämnde Butterskull Ranch. I lägret fann de också spår av stulen boskap, och fler hovavtryck ledde längre österut, som om djuren drivits bort från någon plats längre bort. Spåren och lappen tillsammans pekade mot ranchen norrut.\n\nBland grottans ägodelar fann de dessutom en liten hoard av mynt och värdesaker, rikedomar som bugbears och Brughor samlat på sig genom att råna karavaner och olyckliga resande på vägarna.\n\nOch på grottans väggar fann de något äldre än marauders och orcher, en målning av en alv fångad i ett svart spindelnät, bredvid en märklig goblin med avlångt huvud och kristalliknande utväxt. Samma sorts varelse de sett förut. Ett tecken på att flera mörka krafter rörde sig i regionen samtidigt.\n\nDen natten slog de läger i skogen och gjorde fest av segern.\n\nVid första vakten såg Lior något i mörkret, ett skelett vilande i en urholkad gammal ek. Där fann han ett svärd som lyste med stilla månljus, ett Moon-Touched Sword, märkt av Selûnes kraft. Han väckte Brander, och tillsammans stod de i nattens tystnad och lät det kalla ljuset spela över klingan.\n\nMorgonen därpå fortsatte de sin resa mot Conyberry. Men längs vägen fann de något de inte väntat sig.\n\nOld Owl Well reste sig ur landskapet som en ruin från en annan tid, och redan innan de kom nära kändes något fel. Luften var tung. Marken var stilla på fel sätt. Brander sträckte ut sin gudomliga känsla och fann sanningen dold under rutten stank och mänskliga siluetter. Det som rörde sig där var inga sjuka människor. Det var döda som gick.\n\nOch mitt bland dem stod en man i röda robes. Hamun.\n\nLiors förflutna steg fram ur skuggorna och talade hans namn som om inga år hade gått. \"Intressant att du fortfarande lever... Lior,\" sa Hamun, hans ögon flackade till ringen på Liors hand, en ring lik hans egen.\n\nHamun höjde aldrig rösten. Han behövde inte. Han talade om den avhoppade agenten som Lior hade skickat åt fel håll, om skuld buren av fel anledningar. \"Vet du vad ditt största misstag var, Lior? Du trodde att överlevnad betydde frihet.\"\n\nSedan blev hans ord mörkare. Han talade om barn i Thay, om sinnen som är mjuka, lättare att öppna. \"Vet du vad vi lär barn först i Thay? Att skrik går över. Men till slut skriker alla samma sak: att de vill dö. Det är då arbetet verkligen kan börja.\" Han pekade långsamt mot Lior. \"Men du överlevde. Och det gör dig intressant.\"\n\nRingen på Liors finger pulserade med brådskande ljus. Hamun höll sin egen ring mellan två fingrar. \"Den där ringen var aldrig tänkt som en souvenir. Den märkte dig. Viskningarna du hör? Det är inte galenskap. Det är ekon.\"\n\nHamun sträckte handen mot Liors hand. Silverringen sprack med ett ljud som brustet glas. Gröna nekrotiska flammor kröp över dess yta och färgade silvret svart. När flammorna lade sig lyste Red Wizards sigill svagt i mitten av ringen.\n\nHan lutade huvudet åt sidan. \"Du tror att magi är en gåva. Det är det inte. Det är hunger. Och hungern bryr sig inte om moral.\" Hans blick höll Liors. \"Varje gång du använder din magi, varje gång du flyttar ett mynt utan att röra det, varje gång du känner nyfikenheten vinna över skulden... då väljer en del av dig redan oss.\"\n\nHan vände sig en sista gång. \"Fortsätt springa om du vill, Lior Fenn. Men Red Wizards förlorar inte investeringar. Nu vet vi vart du är. Nästa gång tar vi inte bara dig. Vi är närmare än vad du tror.\"\n\nEtt grönt skimmer uppenbarade sig runt hans hand, en Dimension Door öppnades bakom honom, och Hamun klev igenom och var borta.\n\nKvar stod gruppen vid Old Owl Wells ruiner, med ännu fler frågor än svar.\n\nBrughor Axe-Biter var död. Wyvern Tor var rensat. Spåren pekade mot Butterskull Ranch. Hamun hade återvänt ur Liors förflutna.\n\nMen deras mål låg fortfarande framför dem.\n\nConyberry väntade."
    }
  }
};
...
const NPC_APPEARANCES = {
  sv: {
    ...
    "Brughor Axe-Biter": "En ärrad, stridshärdad bugbear-hövding med tovigt mörkt päls, ett saknat öra och grymma gula ögon, klädd i bucklig ringbrynja och beväpnad med en massiv hackig stridsyxa.",
    "Gog": "En tornhög, trögfattad ogre med grågrön hud, en utstickande underkäke och små pärliga ögon, klädd i grov djurhudsrustning hopsydd av djurpälsar.",
    "Hamun": "En mager man med insjunkna kinder, rakat huvud och genomträngande mörka ögon, draperad i rika karmosinröda kåpor med de arkana sigillen för Red Wizards of Thay, utstrålade ett oroväckande lugn."
  }
};
...
const LOCATION_EVENTS = {
  sv: {
    "Triboar Trail": [
      ...
      "Gruppen jagade ett rådjur och spelade Dragonchess vid lägret (S7).",
      "Lior hittade ett Moon-Touched Sword på ett skelett i en urholkad gammal ek (S7)."
    ],
    "Cragmaw Hideout": [
    ...
    "Wyvern Tor": [
      "Gruppen anlände och fann ett marauder-läger bevakat av bugbears (S7).",
      "Bugbear-vakter lurades ut en efter en med smygande och list (S7).",
      "Brughor Axe-Biter, hans ogre Gog och två bugbears dödades (S7).",
      "Corvus använde en Flaming Sphere på Gog; Brander avslutade ogren (S7).",
      "Spår av stulen boskap och en lapp som nämnde Butterskull Ranch hittades (S7).",
      "En grottmålning visade en alv i ett svart spindelnät och en märklig goblin med avlångt huvud och kristalliknande utväxt (S7).",
      "En hoard av mynt och värdesaker från plundrade karavaner hittades (S7)."
    ],
    "Old Owl Well": [
      "Brander använde Divine Sense och upptäckte att de sjuka människorna egentligen var zombies (S7).",
      "Gruppen mötte Hamun, en Red Wizard of Thay, omgiven av sina odöda (S7).",
      "Hamun kände igen Lior och konfronterade honom om hans förflutna med Red Wizards (S7).",
      "Liors ring sprack efter magisk kontakt med Hamun och ersattes av en Netherese Ring of Protection (S7).",
      "Hamun försvann genom en Dimension Door (S7)."
    ]
  }
};
