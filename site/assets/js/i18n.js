const TRANSLATIONS = {
  en: {
    ...
    "home.objective.text": "Fight through Cragmaw Castle and find Gundren Rockseeker",
  ...
  sv: {
    ...
    "home.objective.text": "Slå er igenom Cragmaw Castle och hitta Gundren Rockseeker.",
